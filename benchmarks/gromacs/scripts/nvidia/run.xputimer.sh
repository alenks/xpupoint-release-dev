...
HPCWL_COMMAND_PREFIX="$PIN_ROOT/pin -t $SRC/XPU-Timer/NVIDIA/CPUPinTool/obj-intel64/xpu-pin-kernelsampler.so -outdir $RESULTS_DIR -perfout cpu.onkernelperf.txt -probemode -nvbittool $SRC/XPU-Timer/NVIDIA/NVBitTool/NVBitTool.so -- "
