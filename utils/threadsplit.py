...
def get_args():
  ...
  parser.add_argument("-o", "--outdir", type=str, default="gpu-perthread", 
        ...
        # Process thread-specific lines
          ...
          if mat:
            ...
            if thread >= num_threads:
              log.warning(f"Thread ID {thread} exceeds expected threads {num_threads}")
              continue
...
def split_threads(nthreads=None, gpudir=".", outdir="gpu-perthread", verbose=False):
  if verbose:
